...
<meta content="3cf708cddf11047c8a81a731ee19fb1b4aff3fed" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/javascripts/bundle_github.js?532918ff1b26ecdc00649523cab30bd517b11ae0" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/douglascrockford/JSON-js/blob/7a18252d0ec1b46b26afb933f65434dc1f7844f5/json2.js'>
  ...
  <body class="logged_out page-blob windows env-production ">
    ...
    <ul class="nav logged_out">
      ...
      <div class="title-actions-bar">
        ...
        <li>
            <a href="/douglascrockford/JSON-js/toggle_watch" class="minibutton btn-watch watch-button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '3cf708cddf11047c8a81a731ee19fb1b4aff3fed'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Watch</span></a>
        </li>
            <li><a href="/douglascrockford/JSON-js/fork" class="minibutton btn-fork fork-button" onclick="var f = document.createElement('form'); f.style.display = 'none'; this.parentNode.appendChild(f); f.method = 'POST'; f.action = this.href;var s = document.createElement('input'); s.setAttribute('type', 'hidden'); s.setAttribute('name', 'authenticity_token'); s.setAttribute('value', '3cf708cddf11047c8a81a731ee19fb1b4aff3fed'); f.appendChild(s);f.submit();return false;"><span><span class="icon"></span>Fork</span></a></li>
...
<div class="subnav-bar">
  ...
  <p class="commit-title ">
      <a href="/douglascrockford/JSON-js"><a href="/douglascrockford/JSON-js/commit/7a18252d0ec1b46b26afb933f65434dc1f7844f5" class="message">[\d+]</a></a>
      
  </p>
  <div class="commit-meta">
    <a href="/douglascrockford/JSON-js/commit/7a18252d0ec1b46b26afb933f65434dc1f7844f5" class="sha-block">commit <span class="sha">7a18252d0e</span></a>

    <div class="authorship">
      <img src="https://secure.gravatar.com/avatar/b871de839c31ddb1d9db8e33e0cb88a6?s=140&d=https://a248.e.akamai.net/assets.github.com%2Fimages%2Fgravatars%2Fgravatar-140.png" alt="" width="20" height="20" class="gravatar" />
      <span class="author-name"><a href="/douglascrockford">douglascrockford</a></span>
      authored <time class="js-relative-date" datetime="2011-08-24T09:42:47-07:00" title="2011-08-24 09:42:47">August 24, 2011</time>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="json2.js/">
      <b><a href="/douglascrockford/JSON-js/tree/7a18252d0ec1b46b26afb933f65434dc1f7844f5" class="js-rewrite-sha">JSON-js</a></b> / json2.js       <span style="display:none" id="clippy_2188" class="clippy-text">json2.js</span>
      ...
      <param NAME="FlashVars" value="id=clippy_2188&amp;copied=copied!&amp;copyto=copy to clipboard">
      ...
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?v5"
             ...
             FlashVars="id=clippy_2188&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="json2.js/" data-permalink-url="/douglascrockford/JSON-js/blob/7a18252d0ec1b46b26afb933f65434dc1f7844f5/json2.js" data-title="json2.js at master from douglascrockford/JSON-js - GitHub" data-type="blob">
        
          <ul class="big-actions">
            <li><a class="file-edit-link minibutton js-rewrite-sha" href="/douglascrockford/JSON-js/edit/7a18252d0ec1b46b26afb933f65434dc1f7844f5/json2.js"><span>Edit this file</span></a></li>
          </ul>
...
<div class="frame frame-loading" style="display:none;" data-tree-list-url="/douglascrockford/JSON-js/tree-list/7a18252d0ec1b46b26afb933f65434dc1f7844f5" data-blob-url-prefix="/douglascrockford/JSON-js/blob/7a18252d0ec1b46b26afb933f65434dc1f7844f5">
...
<div class="lower_footer">
  <div class="site" class="clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2011 <span id="_rrt" title="0.07557s from fe9.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
